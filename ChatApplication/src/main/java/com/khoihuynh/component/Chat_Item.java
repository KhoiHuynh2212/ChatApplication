...
public class Chat_Item extends javax.swing.JPanel {
  ...
  public void setUserProfile(String user) {
    ...
    public void sendSucess() {
        if(label != null ) {
            try {
                java.net.URL iconURL = getClass().getResource("/com/khoihuynh/icon/tick.png");
                if(iconURL != null) {
                 ...
                 System.err.println("Error loading seen icon: " + e.getMessage());
                 e.printStackTrace();
            }
        }
    }
    ...
    public void seen() {
       ...
       if(label != null) {
        try {
            java.net.URL iconURL = getClass().getResource("/com/khoihuynh/icon/double_tick.png");
            if(iconURL != null) {
                ImageIcon icon = new ImageIcon(iconURL);
                label.setIcon(icon);
            } else {
                System.err.println("Icon resource not found: /com/khoihuynh/icon/double_tick.png");
            }
        } catch (Exception e) {
            System.err.println("Error loading seen icon: " + e.getMessage());
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        txt = new com.khoihuynh.swing.JIMSendTextPane();
    ...
    private com.khoihuynh.swing.JIMSendTextPane txt;
