...
package com.khoihuynh.main;

import com.formdev.flatlaf.intellijthemes.FlatArcIJTheme;
import com.khoihuynh.event.EventImageView;
import com.khoihuynh.event.EventMain;
import com.khoihuynh.event.PublicEvent;
import com.khoihuynh.swing.ComponentResizer;
...
public class Main extends javax.swing.JFrame {
    ...
    private void initEvent() {
        PublicEvent.getInstance().addEventMain(new EventMain() {
            ...
            public void showLoading(boolean show) {
                if (show) {    
                    // Switch to loading card
                    cardLayout.show(body, "card5");
    ...
    private void initComponents() {
        ...
        login = new com.khoihuynh.form.Login();
        loading = new com.khoihuynh.form.Loading();
        view_Image = new com.khoihuynh.form.View_Image();
        home = new com.khoihuynh.form.Home();
        ...
        title.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tiltleMousePressed(evt);
            }
        });

        cmdMinimize.setIcon(new javax.swing.ImageIcon("C:\\ChatApplication\\ChatApplicationProject\\src\\main\\resources\\com\\khoihuynh\\icon\\minimize.png")); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon("C:\\ChatApplication\\ChatApplicationProject\\src\\main\\resources\\com\\khoihuynh\\icon\\close.png")); // NOI18N
    ...
    private void tiltleMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tiltleMousePressed
        // TODO add your handling code here:
        pX = evt.getX();
        pY = evt.getY();
    }//GEN-LAST:event_tiltleMousePressed
    ...
    private com.khoihuynh.form.Home home;
    private com.khoihuynh.form.Loading loading;
    private com.khoihuynh.form.Login login;
    private javax.swing.JPanel title;
    private com.khoihuynh.form.View_Image view_Image;
