...
import com.khoihuynh.utils.SafeImage;
...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
       this.pro = pro; 
       imageDown = SafeImage.getImage(SafeImage.loadIcon("/com/khoihuynh/icon/down.png"));
       imageCancel = SafeImage.getImage(SafeImage.loadIcon("/com/khoihuynh/icon/cancel.png"));
       imageFile = SafeImage.getImage(SafeImage.loadIcon("/com/khoihuynh/icon/file.png"));
    }
    ...
    public void paint(Graphics g, JComponent c) {
        ...
        // Define desired progress bar size 
